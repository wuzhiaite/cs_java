package com.wuzhiaite.javaweb.common.codegenerator.utils;
...
public class CodeGeneratorUtil {
    ...
    private static DynamicDataSourceProperties dbsourceProperties;
    /**
     * 自动生成器
     */
    ...
    public void setDbsource( DynamicDataSourceProperties properties){
        CodeGeneratorUtil.dbsourceProperties = properties;
    }
    static {
...
//        strategy.setTablePrefix(pc.getModuleName() + "_");
    ...
    private static void setDataSource() {
        ...
        key = StringUtil.isBlank(key) ? DynamicDataSourceProperties.DEFAULT_DATASOURCE : key ;
        Map<String, Map<String, String>> dbsource = dbsourceProperties.getDbsource();
